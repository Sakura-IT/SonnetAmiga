...
#all : $(SONNETLIB_N) $(SONNETRUN_N) $(TOOLS_N) # not yet
...
distribution :
#	$(LHA) a $(DISTRIBUTION) $(SONNETLIB_N)/$(SONNETLIB_LIB) $(TOOLS_N)/$(TOOLS_GETINFO) $(TOOLS_N)/$(TOOLS_GETINFOPPC) $(SONNETRUN_N)/$(SONNETPATCH) README # not yet
