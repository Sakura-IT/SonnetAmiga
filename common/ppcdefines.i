...
.set IBAT1U_VAL,(VRAM_BASE | BAT_BL_128M | BAT_VALID_SUPERVISOR | BAT_VALID_USER)
...
.set GFX_BASE,0x60000000
.set IBAT3L_VAL,(GFX_BASE | BAT_READ_WRITE)
.set IBAT3U_VAL,(GFX_BASE | BAT_BL_256M | BAT_VALID_SUPERVISOR | BAT_VALID_USER)
